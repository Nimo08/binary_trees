#include "buinary_trees.h"

/*helper function*/

/**
 *is_valid_bst_helper - this function is to perform the in-order traversal and check
...
/* update the previous value to teh current node's value*/
